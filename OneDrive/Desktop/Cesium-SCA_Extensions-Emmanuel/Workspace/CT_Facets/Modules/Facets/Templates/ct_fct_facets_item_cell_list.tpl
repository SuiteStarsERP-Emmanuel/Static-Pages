<div class="ct-fct-facets-item-cell-list" itemprop="itemListElement"  data-item-id="{{itemId}}" data-track-productlist-list="{{track_productlist_list}}" data-track-productlist-category="{{track_productlist_category}}" data-track-productlist-position="{{track_productlist_position}}" data-sku="{{sku}}">
	...
	<div class="ct-fct-item-cell-list-brand-sku-container">
		<span class="enhancedplp-facets-item-cell-grid-brand">{{brand}}</span>
		<span class="ct-fct-brand-item-cell-list-sku">SKU: {{sku}}</span>
	</div>

	<meta itemprop="url" content="{{url}}">
		<div class="facets-item-cell-list-title">
			{{#if itemIsNavigable}}
				<a class="enhancedplp-facets-item-cell-title" href='{{url}}'>
					<span itemprop="name">
						{{name}}
					</span>
				</a>
